...
const targetDivS = document.getElementById('ADDONS');
...
targetDivS.addEventListener('click', function() { /* CLICKING THE DIV */
targetDivS.classList.toggle('clicked');
});

targetDivS.addEventListener('mouseover', function() { /* HOVERING THE DIV */
    targetDiv7.classList.add('hovered');
    targetDiv8.classList.add('hovered');
    targetDiv10.classList.add('hovered');
});
targetDivS.addEventListener('mouseout', function() { /* HOVEROUT THE DIV */
    targetDiv7.classList.remove('hovered');
    targetDiv8.classList.remove('hovered');
    targetDiv10.classList.remove('hovered');
});
